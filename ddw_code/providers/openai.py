...
Implements the `ModelProvider` ABC against OpenAI's `/v1/chat/completions`
endpoint, with SSE streaming, function calling, exponential-backoff retries
on 429/503, and a coarse token counter.
"""
...
class OpenAIProvider(ModelProvider):
    ...
    def _translate_tools(self, tools: list[dict[str, Any]]) -> list[dict[str, Any]]:
        """Translate tool defs to OpenAI `tools` schema."""
